About the method
- `cla_mlp`: Multilayer Perceptron for classification.
- Main parameters: `size` and `decay`.

Didactic goal: keep the same classification line of experiment and change only the learner to a neural model.
