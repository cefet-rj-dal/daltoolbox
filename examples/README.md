...
- [Custom](/Rmd/custom/README.Rmd) — 4 examples (e.g., custom_transformation, custom_classification, custom_clustering). Didactic examples of custom extensions integrated into the Experiment Line workflow.
