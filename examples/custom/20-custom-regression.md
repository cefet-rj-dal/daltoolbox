...
The important structural point is that custom regressors should inherit from `regression(attribute)`, so they participate in the same evaluation and tuning workflow as the native `reg_*` models.
...
```
##        mse     smape           R2
## 1 103.0929 0.3299567 -0.004030478
```
