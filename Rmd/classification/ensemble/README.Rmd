# Ensemble Classifiers Examples

Classifiers that combine multiple base models to achieve more robust and generalizable predictions.

> Slide deck: `d045-ensemble.pdf` (Bagging, Random Forest, AdaBoost, and XGBoost).
...
- [22-boosting-xgboost.md](/examples/classification/ensemble/22-boosting-xgboost.md) - `cla_xgboost`: gradient boosting classifier with `xgboost`.
