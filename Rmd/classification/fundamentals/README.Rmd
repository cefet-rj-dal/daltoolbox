...
> Slide deck: [d042-classification-fundamentals.pdf](https://github.com/cefet-rj-dal/daltoolbox/blob/main/examples/pdf/d042-classification-fundamentals.pdf) covers the baseline and the decision tree (01, 02). It does not yet cover the `rpart` backend (21) — content to merge in is drafted as [d042-classification-fundamentals-ADDENDUM.pdf](https://github.com/cefet-rj-dal/daltoolbox/blob/main/examples/pdf/d042-classification-fundamentals-ADDENDUM.pdf).
