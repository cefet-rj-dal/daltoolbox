...
- [sample_oversampling.md](sample_oversampling.md) - `bal_oversampling`: class oversampling with random replication or local SMOTE.
- [sample_subsampling.md](sample_subsampling.md) - `bal_subsampling`: random class undersampling to the minority count.
...
- [feature_selection_fss.md](feature_selection_fss.md) - `feature_selection_fss`: forward stepwise subset search for numeric targets.
- [feature_selection_information_gain.md](feature_selection_information_gain.md) - `feature_selection_info_gain`: rank predictors by information gain.
- [feature_selection_lasso.md](feature_selection_lasso.md) - `feature_selection_lasso`: L1-based embedded feature selection for numeric targets.
- [feature_selection_relief.md](feature_selection_relief.md) - `feature_selection_relief`: rank predictors by nearest-hit and nearest-miss comparisons.
- [feature_selection_stepwise.md](feature_selection_stepwise.md) - `feature_selection_stepwise`: stepwise GLM-based selection for classification.
