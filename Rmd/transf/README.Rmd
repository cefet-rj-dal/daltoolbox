...
- [custom_smote_external.md](custom_smote_external.md) - `smote_custom`: ad hoc custom transformation defined in the example itself, using `smotefamily` outside the package namespace.
