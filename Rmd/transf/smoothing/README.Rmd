# Smoothing and Discretization Examples

These examples summarize continuous values into intervals, frequencies, or cluster-defined bins.

> Slide deck: [d036_transf_smoothing.pdf](https://github.com/cefet-rj-dal/daltoolbox/blob/main/examples/pdf/d036_transf_smoothing.pdf).
...
- [43-smoothing-generic.md](/examples/transf/smoothing/43-smoothing-generic.md) - `smoothing`: base family and tuning logic behind the smoothing variants.
- [44-smoothing-quantization.md](/examples/transf/smoothing/44-smoothing-quantization.md) - `smoothing_quantization`: one-dimensional k-means quantization without class supervision.
