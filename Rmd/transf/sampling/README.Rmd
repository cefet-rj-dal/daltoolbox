...
- [04-sampling-balance.md](/examples/transf/sampling/04-sampling-balance.md) - `sample_balance`: up-sampling or down-sampling through the sampling interface.
- [05-sampling-groups.md](/examples/transf/sampling/05-sampling-groups.md) - `sample_groups`: select entire groups defined by a categorical attribute using cluster sampling.
