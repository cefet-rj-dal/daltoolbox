## Custom SMOTE Outside the Package

This example shows how to create an ad hoc transformation outside `daltoolbox` by defining a custom class in the example itself. The implementation below mirrors the previous `smotefamily::SMOTE`-based approach without adding code to the package namespace.
